package uz.xbakhromjon.simple.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof uz.xbakhromjon.simple.service.EmailAlreadyUsedException ||
            ex instanceof uz.xbakhromjon.simple.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof uz.xbakhromjon.simple.service.InvalidPasswordException
